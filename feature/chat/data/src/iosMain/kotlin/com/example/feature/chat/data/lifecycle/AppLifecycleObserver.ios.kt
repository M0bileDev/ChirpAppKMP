...
actual class AppLifecycleObserver {
    actual val isInForeground: Flow<Boolean> = callbackFlow {
        ...
        val isCurrentlyInForeground = when(applicationState){
            // application is in foreground, reacts to user input
            UIApplicationState.UIApplicationStateActive -> true
            // application is in foreground, but notification center is dragged down
            // or there is ongoing phone call...
